# Generated by Django 5.1.2 on 2024-12-24 15:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puan', models.IntegerField(default=0)),
                ('kullanici', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('sorun', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yorumlar', to='haritalar.trafiksorunu')),
            ],
        ),
    ]
